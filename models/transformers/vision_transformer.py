#implementation from https://github.com/FomalhautB/3D-RETR
...
from .utils import load_state_dict_partially
...
class DistilledVisionTransformer(VisionTransformer):
    def __init__(self, *args, **kwargs):
        ...
        self.dist_token = nn.Parameter(torch.zeros(1, num_tokens, self.embed_dim))
        num_patches = self.patch_embed.num_patches
        self.pos_embed = nn.Parameter(torch.zeros(1, num_patches + 1 + num_tokens, self.embed_dim))
